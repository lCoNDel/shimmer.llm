...
1.  **Iniciar Servidor**: Levanta `open-webui` (prod.yml), `asistente_nautico` (bots.yml) y `tsamaps_server_dev` (proxy.yml) en ese orden, y abre el túnel ngrok en el puerto 5050.
