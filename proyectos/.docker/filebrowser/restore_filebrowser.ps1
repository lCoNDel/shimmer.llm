...
# 1. Comprobar si el contenedor está activo
...
docker exec $container filebrowser users update admin --password *H3br4nc2385 --database /app/backend/data/filebrowser.db
